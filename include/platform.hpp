...
#ifdef DOKUN_USE_GLFW // if using GLFW
#define DOKUN_GLFW
#undef DOKUN_X11  // un-define X11
#endif
...
////////////
    ...
    #define __desktop__ // on a desktop
	...
	#endif
	#ifdef DOKUN_USE_OPENGL               // use opengl (OPTIONAL), glew (REQUIRED IF USING OPENGL)
		#define GLEW_STATIC
        #include <GL/glew.h>
		#include <GL/wglew.h>
        #include <GL/gl.h>
        #include <GL/glu.h>
	#endif
	#ifdef DOKUN_USE_VULKAN               // use vulkan (OPTIONAL)
...
////////////
	...
	#endif 
	#ifdef DOKUN_USE_OPENGL           // opengl (OPTIONAL), glew (REQUIRED If using OpenGL and must be included before gl.h and glu.h)
		#define GLEW_STATIC
        #include <GL/glew.h>
	    #ifdef DOKUN_X11
			#include <GL/glxew.h>
...
////////////
	...
	#define __desktop__         // on a desktop
	#ifdef DOKUN_USE_OPENGL         // use opengl (OPTIONAL)
	    #include <OpenGL/gl.h>
